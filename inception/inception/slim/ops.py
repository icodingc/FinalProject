...
"""Contains convenience wrappers for typical Neural Network TensorFlow layers.
   ...
   some function refer to contrib.layers
"""
...
from inception.slim import initializers
...
def deconv2d(inputs,
  ...
  with tf.variable_op_scope([inputs], scope, 'Deconv', reuse=reuse):
    ...
    stride_h, stride_w = _two_element_tuple(stride)
    # last dimension
    num_filters_in = _last_dimension(inputs.get_shape(),min_rank=4)
